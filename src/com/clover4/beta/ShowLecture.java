    		...
    		if ("com.clover.LocationChangedBroadcast".equals(intent.getAction())){
    			...
    			if (mEventItem != null){
    				...
    				if (mEventItem.type == 1){
    					...
    					Intent lectureIntent = new Intent(ShowLecture.this,ShowLecture.class);
						PendingIntent mPendingIntent= 
								PendingIntent.getActivity(ShowLecture.this, 0, lectureIntent, PendingIntent.FLAG_CANCEL_CURRENT);
						Notification mNotification = new Notification.Builder(ShowLecture.this).
						...
						NotificationManager mNotificationManager = 
								(NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
						Intent lectureIntent = new Intent(ShowLecture.this,ShowAct.class);
						PendingIntent mPendingIntent= 
								PendingIntent.getActivity(ShowLecture.this, 0, lectureIntent, PendingIntent.FLAG_CANCEL_CURRENT);
						Notification mNotification = new Notification.Builder(ShowLecture.this).
								setSmallIcon(R.drawable.ic_launcher).
